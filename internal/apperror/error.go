...
// here we will create diff. errors according to the guideline
// if you don't have any guideline then pls create it
// guideline is needed for developers
var (
	ErrNotFound = NewAppError(nil, "not found", "", "US-000003")
)

type AppError struct {
	Err              error  `json:"-"` //for ignoring
